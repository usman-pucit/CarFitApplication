...
class HomeViewController: BaseViewController, AlertDisplayer {
    // MARK: IBOutlets
    ...
    private lazy var calenderViewObject: CalendarView = {
    ...
    private func setupUI() {
        ...
        self.navBar.topItem?.title = "Car Fit"
    ...
    private func onbindViewModel() {
        ...
        self.viewModel.performRequestFromMock()
